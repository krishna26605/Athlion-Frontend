            ...
            >
                ...
                <div className="mb-8 md:mb-12">
                    ...
                    <h1 className="text-3xl md:text-5xl font-black italic tracking-tighter uppercase mb-2 leading-none">
                        Edit <span className="text-white">Race</span>
                    </h1>
                    <p className="text-gray-400 text-sm md:text-base">Modify the parameters for this Athlion competitive event.</p>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className="w-full bg-zinc-900 border border-white/5 rounded-xl p-3 md:p-4 focus:border-[#f82506]/50 transition-all outline-none font-bold text-sm text-white"
                                >
