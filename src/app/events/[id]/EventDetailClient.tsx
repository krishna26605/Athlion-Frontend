...
export default function EventDetailClient() {
            ...
            const options = {
                ...
                handler: async function (response: any) {
                    try {
                        ...
                        alert('Payment verified on gateway but failed on server support.');
    ...
    if (!event) return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-black text-gray-500">
            ...
            <p className="text-xl font-black italic uppercase">Event Not Found</p>
                        ...
                        >
                            ...
                            <div className="relative h-48 md:h-80 w-full mb-8 md:mb-12 rounded-2xl md:rounded-3xl overflow-hidden group z-10">
                                <img 
                                    ...
                                    alt={`Athlion Race Pass - ${event.name}`}
                            ...
                            {existingRegistration ? (
                                <div className="space-y-6 text-center">
                                    ...
                                    <p className="text-gray-400 text-xs md:text-sm">
                                        You have successfully secured your spot for this event.
                                    </p>
                                                        ...
                                                        <div className="flex items-center justify-between bg-green-500/10 border border-green-500/20 rounded-xl p-4">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-[10px] text-green-500/70 font-bold">Coupon applied!</p>
                                                                </div>
                                                            </div>
                                                            <button
                                                                type="button"
                                                ...
                                                <div className="pt-6 border-t border-white/5 space-y-4">
                                                    ...
                                                    <div className="flex gap-4">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex-[2] btn-primary p-3 md:p-4 py-3 text-xs md:text-sm font-black italic tracking-widest disabled:opacity-50"
                                                        >
                                                            {bookingLoading ? <Loader2 className="animate-spin mx-auto" size={18} /> : 'PAY & REGISTER'}
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
