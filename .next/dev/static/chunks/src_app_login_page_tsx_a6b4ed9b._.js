...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        ...
        setError(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('auth/login', data);
...
_s(LoginPage, "JTcj5aS9ld11r1d+jqYG+GmNPYo=", false, function() {
    return [
