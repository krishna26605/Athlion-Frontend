...
function EventDetailPage() {
    ...
    const handleBooking = async ()=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`registrations/book/${id}`, regData);
